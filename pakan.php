...
<head>
    ...
    <title>Data Pakan - Sistem Informasi Peternakan Ayam</title>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link active-custom" href="pakan.php">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Data Pakan</h1>
                    <p class="text-muted">Kelola data penggunaan pakan ayam.</p>
                    ...
                    <div class="custom-panel">
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" placeholder="Cari tanggal atau jenis pakan...">
                            </div>
                            <div class="col-md-5">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            <div class="text-muted">Menampilkan 1 - 1 dari 1 data</div>
                            <div>
