...
<head>
    ...
    <title>Data Kesehatan & Mortalitas - Sistem Informasi Peternakan Ayam</title>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link active-custom" href="kesehatan.php">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Data Kesehatan & Mortalitas</h1>
                    <p class="text-muted">Kelola data kesehatan ayam dan angka kematian.</p>
